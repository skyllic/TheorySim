...
public class Theory8 extends Theory {
    ...
    public String name  = "Chaos Theory";
    ...
    public Theory8(double pubMark) {
        ...
        this.variables[0] = new Variable(1.5172, 10, Math.pow(2, 0.1), 0, false, true, false, true, false, new double[2]);
    ...
    public void printSummary() {
        ...
        System.out.print(String.format("%.4f", 60*60*Math.log(this.publicationMultiplier) / Math.log(10) / 0.15 / this.seconds * 24));
        System.out.print("\t" + String.format("%.4f", this.publicationMultiplier) + "\t");
        System.out.print("\tT8R\t\t");
