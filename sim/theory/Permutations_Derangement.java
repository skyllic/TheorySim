 ...
 * Idle.
 */
public class Permutations_Derangement extends Theory {
    ...
    public Permutations_Derangement(double pubMark) {
        super(2, pubMark);
        this.name = "Permutations Derangement";
 /** 
        this.q1 = 0;
        this.q2 = 0;
        this.q3 = 0;
...
/**
        this.q1 = Variable.add(this.q1,
                this.variables[0].value + this.q2 + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));

        if (this.milestoneLevels[0] > 0) {
            this.q2 = Variable.add(this.q2,
                    this.variables[1].value + this.q3 + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else {
            this.q2 = Variable.add(this.q2,
                    this.variables[1].value + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        }

        if (this.milestoneLevels[0] > 1) {
            this.q3 = Variable.add(this.q3,
                    this.variables[2].value + this.q4 + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else if (this.milestoneLevels[0] == 1) {
            this.q3 = Variable.add(this.q3,
                    this.variables[2].value + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else {
            // Do nothing with q3.
        }
        if (this.milestoneLevels[0] > 1) {
            this.q4 = Variable.add(this.q4,
                    this.variables[3].value + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else {
            // Do nothing with q4.
        }

        this.r1 = Variable.add(this.r1,
                this.variables[4].value + this.r2 + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));

        if (this.milestoneLevels[1] > 0) {
            this.r2 = Variable.add(this.r2,
                    this.variables[5].value + this.r3 + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else {
            this.r2 = Variable.add(this.r2,
                    this.variables[5].value + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        }

        if (this.milestoneLevels[1] > 1) {
            this.r3 = Variable.add(this.r3,
                    this.variables[6].value + this.r4 + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else if (this.milestoneLevels[1] == 1) {
            this.r3 = Variable.add(this.r3,
                    this.variables[6].value + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else {
            // Do nothing with r3.
        }
        ...
        if (this.milestoneLevels[1] > 1) {
            this.r4 = Variable.add(this.r4,
                    this.variables[7].value + Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency));
        } else {
            // Do nothing with r4.
        }

        this.rhodot = this.q1 * (1 + 0.05 * this.milestoneLevels[2]) + this.r1 * (1 + 0.05 * this.milestoneLevels[3]) +
                Math.log10(Permutations_Derangement.adBonus) + Math.log10(this.tickFrequency)
...
*/
    ...
    public void idleUntil(Permutations_Derangement theory2, double variableCost) {
