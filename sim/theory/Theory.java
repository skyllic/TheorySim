...
public class Theory implements ITheory{
    ...
    private void initialiseVariables() {
        if (Theory.theoryNumber == 1) {
            ...
            this.variables[1] = new Variable(2, 5000, Math.pow(2, 0.1), 0, false, true, false, false, false,
                    new double[2]);
            this.variables[2] = new Variable(3, 3 * Math.pow(10, 25), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
            this.variables[3] = new Variable(4, 8 * Math.pow(10, 50), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
            this.variables[4] = new Variable(2, 2 * Math.pow(10, 6), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
            this.variables[5] = new Variable(2, 3 * Math.pow(10, 9), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
            this.variables[6] = new Variable(3, 4 * Math.pow(10, 25), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
            this.variables[7] = new Variable(4, 5 * Math.pow(10, 50), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
        } else if (Theory.theoryNumber == 3) {
            this.variables = new Variable[12];
            // Order of variable is b1, b2, b3, c11, c12, c13, c21, c22, c23, c31, c32, c33.
            this.variables[0] = new Variable(1.18099, 10, Math.pow(2, 0.1), 0, false, true, false, true, false,
                    new double[2]);
            this.variables[1] = new Variable(1.308, 10, Math.pow(2, 0.1), 0, false, true, false, false, false,
                    new double[2]);
            this.variables[2] = new Variable(1.675, 3000, Math.pow(2, 0.1), 0, false, true, false, false, false,
                    new double[2]);
            ...
            this.variables[8] = new Variable(2.27, Math.pow(10, 5), 2, 1, true, true, false, false, false,
                    new double[2]);
            this.variables[9] = new Variable(1248.27, Math.pow(10, 4), 2, 1, true, true, false, false, false,
                    new double[2]);
            this.variables[10] = new Variable(6.81774, Math.pow(10, 3), 2, 1, true, true, false, false, false,
                    new double[2]);
            ...
            this.variables[6] = new Variable(1.255, Math.pow(10, 7), Math.pow(2, 0.1), 0, false, true, false, false,
                    false,
                    new double[2]);
            ...
            this.variables[2] = new Variable(16, 1000000, Math.pow(2, 0.1), 1, false, true, false, false, true,
                    new double[2]);
            this.variables[3] = new Variable(256, 50, 1, 0, false, false, true, false, false, new double[2]);
            this.variables[4] = new Variable(Math.pow(10, 5.65), 1000, 2, 1, true, true, false, false, false,
                    new double[2]);
    ...
    public void coastUntilPublish() {
        ...
        //Coasts until current tau gained per hour is not decreasing.
        while (this.tauPerHour <= tauRate) {

            this.tauPerHour = tauRate;
            this.moveTick();
            tauRate = 60 * 60 * Math.log(this.publicationMultiplier) / Math.log(10) / this.pubCoefficient
                    / this.seconds;
