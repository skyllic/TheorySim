...
public class Theory1 extends Theory {
    ...
    public Theory1(double pubMark) {
        ...
        this.variables[4] = new Variable(Math.pow(10, 4.5), 10000, 10, 1, true, true, false, false, false, new double[2]);
        this.variables[5] = new Variable(Math.pow(10, 8), Math.pow(10, 10), 10, 1, true, true, false, false, false, new double[2]);
    ...
    public void adjustWeightings(int i) {
        ...
        double rhodotMultiplier = Math.pow(10, rhoDotDiff);
        double coefficient = rhodotMultiplier * (1.5 - 1) / (1.5 * (rhodotMultiplier - 1));
        coefficient = Math.log10(coefficient);
        this.variableWeights[i] = 10 + coefficient;

       /**  this.variableWeights[0] = 11.1 + (0.018*(this.variables[0].level % 10) - 0.11);
